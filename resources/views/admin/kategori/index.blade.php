...
@section('content')
    <x-admin-page-header
        title='Kategori Produk <span class="badge bg-soft-dark text-dark ms-2">{{ number_format($kategoris->count()) }}</span>'
        subtitle="Daftar semua kategori produk" />
        ...
        <div class="col-lg-4">
            <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-header">
                    <h4 class="card-header-title">Menambahkan kategori</h4>
                </div>
                <!-- End Header -->
                    ...
                    <table id="datatable"
                        ...
                        <tbody>
                            @forelse ($kategoris as $kategori)
                                <tr>
                                    <td>{{ $kategori->nama }}</td>
                                    <td>{{ $kategori->products->count() }} produk</td>
                                    <td class="text-end">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end mt-1"
                                                    ...
                                                    <form action="{{ route('admin.kategori.destroy', $kategori) }}" method="post"
                                                        onsubmit="return confirm('Anda yakin ingin menghapus {{ $kategori->nama }}?')">
                                                        @csrf @method('delete')
