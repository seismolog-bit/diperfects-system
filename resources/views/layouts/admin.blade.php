...
<head>
    ...
    <!-- Title -->
    <title>Dashboard | DI' Perfects Beauty & Authentic Perfume</title>
                                    ...
                                    <div class="card-body card-body-height">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar avatar-xs avatar-4x3"
                                                        src="{{ asset('assets/svg/brands/google-webdev-icon') }}.svg"
                                                        alt="Image Description">
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-3">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar avatar-xs avatar-4x3"
                                                        src="{{ asset('assets/svg/brands/frontapp-icon.svg') }}"
                                                        alt="Image Description">
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-3">
                ...
                <div class="col-6">
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="layoutSkinsRadio1">
                            <img class="form-check-img" src="{{ asset('assets/img/415x310/img1.jpg') }}"
                                alt="Image Description">
                        </label>
                ...
                <div class="col-6">
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="layoutSkinsRadio2">
                            <img class="form-check-img" src="{{ asset('assets/img/415x310/img2.jpg') }}"
                                alt="Image Description">
                        </label>
                    ...
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio1">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts-light/sidebar-default.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="dark">
                            <img class="form-check-img" src="{{ asset('assets/svg/layouts/sidebar-default.svg') }}"
                ...
                <div class="col-6">
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio2">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts-light/sidebar-dark.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="dark">
                            <img class="form-check-img" src="{{ asset('assets/svg/layouts/sidebar-dark.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="default">
                        </label>
                ...
                <div class="col-6">
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="sidebarNavOptions1">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts-light/demo-layouts-default-classic.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="dark">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts/demo-layouts-default-classic.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="default">
                        </label>
                ...
                <div class="col-6">
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="sidebarNavOptions2">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts-light/demo-layouts-nav-tabs.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="dark">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts/demo-layouts-nav-tabs.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="default">
                        </label>
                    ...
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="headerLayoutOptions1">
                            <img class="form-check-img"
                                ...
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts-light/header-default-container.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </label>
                        <span class="form-check-text">Default</span>
                    </div>
                    ...
                    <div class="form-check form-check-label-highlighter text-center">
                        ...
                        <label class="form-check-label mb-2" for="headerLayoutOptions2">
                            <img class="form-check-img"
                                ...
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="form-check-img"
                                src="{{ asset('assets/svg/layouts-light/header-double-line-container.svg') }}"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </label>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar" src="{{ asset('assets/img/160x160/img9.jpg') }}"
                                alt="Image Description">
                        </div>
